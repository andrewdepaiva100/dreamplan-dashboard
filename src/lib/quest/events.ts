...
if (typeof window !== "undefined") {
  ...
  queueMicrotask(() => {
    void Promise.all([
      ...
      import("./act2BossRemaster"), import("./act2Wildlife"), import("./global2_5dPolish"), import("./desktopActSelector"), import("./desktopControlsPolish"), import("./interactionPolish"),
      ...
      act2SeasonIdentity, act2BramForgemaster, act2BramWeaponOwnership, act2SeasonChallenges, act2BossRemaster, act2Wildlife, global25DPolish,
