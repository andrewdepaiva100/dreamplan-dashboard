...
function openingBeats(): Beat[] {
  return [
    ...
    { andrew: "I call it the Love Sword. Mine has its blue twin, and this one is yours. Not because I think you need rescuing — I've met you, remember? — but because loving you has never meant standing in front of you. It means standing with you.", replies: [r("Then I'll carry it like you're beside me.", "That's exactly what I hoped you'd say. And when you swing it, imagine me somewhere nearby being extremely impressed and pretending I wasn't worried at all."), r("You really made us matching swords?", "Of course I did. We are getting married. Matching swords felt like a perfectly reasonable extension of matching a life."), r("I don't need rescuing. But I do need you.", "Good. Because I never want to be your hero from a distance. I want to be your person up close — the one who listens, stays, apologizes, laughs with you, and keeps choosing you.")] },
    ...
    { andrew: "I kept thinking about the ceremony without those pages. We could have managed. We could have laughed about it. But I know us — we'd always remember the missing notes. So I turned around. Maybe that's marriage too: noticing what's been scattered and caring enough to go back for it.", replies: [r("Then we'll put it back together.", "One page at a time. And someday, when something harder than music gets scattered, we'll do the same thing. No keeping score. No leaving the other person alone with the pieces."), r("I love that you cared this much.", "I care this much about everything that becomes ours. The song, the home, the ridiculous grocery list on a Tuesday, all of it. Especially you."), r("You know I would've married you without the music.", "I know. I'd marry you in complete silence. But if I can give you the song too, let me give you the song.")] },
    ...
    { andrew: "Find the three pages for me, love. I'll hold this part of the square steady and keep the Clamour from swallowing the whole town. Bring our melody back, and we'll remind it that fear can make noise without becoming truth.", replies: [r("I'll bring our song home to you.", "And I'll be right here when you do. No matter which street you take, come back to me."), r("Only if you promise to stay safe.", "I promise to be sensible, which is almost the same thing. And I promise I won't try to be brave in any way that would make you roll your eyes at me."), r("Hold my place. I'll be back.", "Always. Your place with me isn't something you can lose by walking away for a while.")] },
    { andrew: "And when we've finished this, I'm going ahead to the Cathedral. No more detours. The next time you find me waiting, I'll be exactly where I promised — probably trying not to cry before you even reach the altar.", replies: [r("You are absolutely going to cry.", "Completely. I've accepted it. My only remaining goal is to make it look dignified for at least three seconds."), r("Then wait for me there.", "With everything I have. Take the road at your pace, Maria. I don't need you to hurry toward forever."), r("I love you, Andrew.", "I love you too. In every loud place, every quiet place, every ordinary day after this one. Now go find our song, future wife.")] },
  ];
}
