...
const MAP_ZONE_MOOD: Record<ZoneId, { wash: string; note: string }> = {
  ...
  wedding_garden: { wash: "#f6cad6", note: "Every path was planted for this day" },
  the_haven: { wash: "#d8e6d2", note: "A home for all the ordinary forever" },
          ...
          {mapSnap ? (
            <>
              <div className="-mt-1 flex items-end justify-between gap-3 border-b border-[#c8ad79]/45 pb-3">
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-[0.24em] text-[#aa8746]">
                    {ZONES[mapSnap.zone].act}
                  </p>
                  <p className="mt-0.5 font-display text-lg font-bold text-navy">
                    {ZONES[mapSnap.zone].title}
                  </p>
                </div>
                <p className="max-w-[45%] text-right font-serif-italic text-[11px] italic leading-snug text-[#8d744e]">
                  {MAP_ZONE_MOOD[mapSnap.zone].note}
                </p>
              </div>
              ...
              <div>
                <div className="flex items-center gap-3">
                  <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#a98543]">
                    Fast travel
                  </p>
                  <div className="h-px flex-1 bg-gradient-to-r from-[#c7a76b]/50 to-transparent" />
                </div>
                      ...
                      <button
                        ...
                        className={`flex items-center gap-3 rounded-xl border p-2.5 text-left transition ${
                          here
                            ...
                            : unlocked
                              ? "border-gold/30 bg-white/75 hover:border-gold/60 hover:bg-[#fff9e9]"
            ...
            <p className="py-12 text-center font-serif-italic text-sm italic text-navy/60">
              Charting the realm…
            </p>
          )}
        </GlassPanel>
